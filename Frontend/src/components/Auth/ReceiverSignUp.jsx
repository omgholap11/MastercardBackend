...
import { Mail, Lock, User, Phone, MapPin, HandHeart, ArrowLeft, Building2 } from 'lucide-react';
...
const ReceiverSignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:5001/receiver/signup', formData, {
      ...
      if (response.data) {
        ...
        console.log('Receiver registered successfully:', response.data);
      }
    } catch (err) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-green-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-primary mb-2">Become a Receiver</h1>
          <p className="text-secondary">Join our community and get the help you need</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              {loading ? 'Creating account...' : 'Register as Receiver'}
            </button>
          </form>
